...
// a 4-digit number with at least two distinct digits. Your program should perform the 
// following routine on the number: Arrange the digits in descending order and in ascending 
...
// be performed until 6174 is reached. For example: if num is 3524 your program should return 
// 3 because of the following steps: 
